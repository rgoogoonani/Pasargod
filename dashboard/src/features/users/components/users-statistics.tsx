      ...
      <div className="w-full">
        <Card dir={dir} className="group relative w-full overflow-hidden px-4 py-6 transition-colors hover:bg-accent/40">
          <CardTitle className="flex min-w-0 items-center justify-between gap-x-4 overflow-hidden">
            ...
            <span className={cn('mx-2 shrink-0 text-3xl tabular-nums transition-all duration-500', isIncreased.online_users ? 'animate-zoom-out' : '')}>
      ...
      <div className="w-full">
        <Card dir={dir} className="group relative w-full overflow-hidden px-4 py-6 transition-colors hover:bg-accent/40">
          <CardTitle className="flex min-w-0 items-center justify-between gap-x-4 overflow-hidden">
            ...
            <span className={cn('mx-2 shrink-0 text-3xl tabular-nums transition-all duration-500', isIncreased.active_users ? 'animate-zoom-out' : '')}>
      ...
      <div className="w-full sm:col-span-2 lg:col-span-1">
        <Card dir={dir} className="group relative w-full overflow-hidden px-4 py-6 transition-colors hover:bg-accent/40">
          <CardTitle className="flex min-w-0 items-center justify-between gap-x-4 overflow-hidden">
            ...
            <span className={cn('mx-2 shrink-0 text-3xl tabular-nums transition-all duration-500', isIncreased.total_user ? 'animate-zoom-out' : '')}>
